...
const posts = [
  ...
  { id: 3, title: "Day 3 Tour: Museum visit", img: day3Pic, date: "April 8, 2025" },
  { id: 4, title: "Day 4 Tour: Bangko Sentral and Hytech company visit", img: day4Pic, date: "April 4, 2025" },
  { id: 5, title: "Day 5 Tour: LRT and TEC visit", img: day5Pic, date: "April 5, 2025" },
  { id: 6, title: "Day 6 Tour: Baguio tour", img: day6Pic, date: "April 6, 2025" },
  { id: 7, title: "Day 7 Tour: Free Time", img: day7Pic, date: "April 7, 2025" },
];
  ...
  return (
    <div className="blog-section">
      <Container className="px-4">
        <Row className="g-4">
          {posts.map((post, idx) => {
            const offsetClass = idx === posts.length - 1 ? 'offset-md-4' : '';

            return (
              <Col md={4} sm={6} xs={12} key={idx} className={offsetClass}>
                  ...
                  <Card className="border-0 shadow-sm h-100 d-flex flex-column justify-content-between">
                    <div>
                      ...
                      <Card.Body className="d-flex flex-column">
                        <Badge bg="light" text="dark" className="mb-2 align-self-start" style={{ fontSize: '0.75rem' }}>
                          Tour Activity
                        </Badge>
